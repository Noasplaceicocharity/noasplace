                    ...
                    <div className="flex flex-wrap gap-2">
                      {tags.map((tag) => (
                        <Link
                          ...
                          className="inline-flex items-center rounded-full bg-white px-3 py-1 text-sm font-medium text-brand-800 hover:bg-brand-100 transition-colors shadow-sm border border-brand-100/30"
                        >
                          {tag}
                        </Link>
                      ))}
          ...
          <div className="lg:col-span-3">
            {posts.length === 0 ? (
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-ink mb-2">No blog posts yet</h3>
                <p className="text-ink/60">Check back soon for updates and stories from our community.</p>
              </div>
            ) : (
                ...
                {posts.map((post) => (
                  ...
                  >
                    ...
                    <div className="absolute top-4 right-4 opacity-20 group-hover:opacity-30 transition-opacity z-10">
                      <svg className="h-8 w-8 text-[#FFB800]" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M12,2 L15,9 L22,9 L16,14 L18,21 L12,17 L6,21 L8,14 L2,9 L9,9 Z" />
                      </svg>
                    </div>
                    ...
                    <div className="p-8">
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        {post.featured && (
                          <span className="inline-flex items-center rounded-full bg-[#FFB800] px-3 py-1 text-xs font-bold text-ink shadow-sm">
                            ⭐ Featured
                          </span>
                        )}
                      </div>

                      <h2 className="text-2xl font-extrabold text-brand-800 group-hover:text-brand-600 transition-colors mb-3">
                        {post.title}
                      </h2>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="inline-flex items-center text-brand-700 group-hover:text-brand-800 font-bold text-sm group-hover:translate-x-1 transition-all bg-brand-50 px-4 py-2 rounded-full group-hover:bg-brand-100">
                          Read more
