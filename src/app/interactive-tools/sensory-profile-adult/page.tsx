...
export default function SensoryProfileAdultPage() {
  ...
  // Sound trigger options for adults
  const soundTriggerOptions = [
    ...
    "Traffic noise", "Office noise", "Fire alarms", "Vacuum cleaners", "Air conditioning units",
    "Telephone rings", "Door slamming", "Loud machinery"
  ];

  // Sound calming options for adults
  const soundCalmingOptions = [
    ...
    "Jazz music", "Acoustic music", "Binaural beats", "Sound therapy"
  ];

  // Light trigger options for adults
  const lightTriggerOptions = [
    ...
    "Office lighting", "Shopping centre lights", "Stadium lighting", "Neon signs"
  ];

  // Light calming options for adults
  const lightCalmingOptions = [
    ...
    "Warm white lighting", "Dimmer switches", "Blackout curtains", "Soft bedside lighting"
  ];

  // Touch trigger options for adults
  const touchTriggerOptions = [
    ...
    "Seatbelts or restraints", "Medical equipment", "Certain food textures", "Rough surfaces"
  ];

  // Touch calming options for adults
  const touchCalmingOptions = [
    ...
    "Weighted vests", "Compression clothing", "Soft clothing", "Textured stress balls"
  ];

  // Smell trigger options for adults
  const smellTriggerOptions = [
    ...
    "Industrial smells", "Certain food preparation", "Strong spices", "Chemical cleaners"
  ];

  // Smell calming options for adults
  const smellCalmingOptions = [
    ...
    "Chamomile", "Sandalwood", "Rose", "Jasmine"
  ];
  ...
  // Movement trigger options for adults
  const movementTriggerOptions = [
    ...
    "Public transport", "Crowded shopping areas", "Unpredictable crowds", "Fast-paced environments"
  ];

  // Movement calming options for adults
  ...
  const warningSignsOptions = [
    ...
    "Increased heart rate", "Sweating", "Nausea", "Feeling dizzy or lightheaded"
  ];
  ...
  const copingStrategiesOptions = [
    ...
    "Progressive muscle relaxation", "Visualization techniques", "Grounding exercises", "Time management strategies"
  ];

  // Safe spaces options
  const safeSpacesOptions = [
    "My home", "A quiet library", "Outdoors in nature", "A trusted friend's house",
    "A quiet corner at work", "The bathroom for privacy", "A car or vehicle", "A park or outdoor space",
    "A quiet café", "A sensory room if available", "My bedroom", "Anywhere with trusted people",
    "A quiet office space", "A meditation room", "A quiet corner in a shop", "A peaceful garden"
  ];
  ...
  const emergencyStrategiesOptions = [
    ...
    "Call a crisis helpline", "Use emergency contact numbers", "Go to a safe space", "Use emergency sensory tools"
  ];
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      pdf.setFontSize(18);
      pdf.setFont(undefined, 'bold');
      pdf.text('SENSORY PROFILE', margin + 5, yPosition + 10);
      yPosition += 25;
      ...
      addText(`Occupation: ${formData.occupation || 'Not provided'}`);
      ...
      // Save the PDF
      const fileName = `${formData.name || 'Adult'}_Sensory_Profile.pdf`;
      pdf.save(fileName);
  ...
  return (
    <main className="bg-background text-ink min-h-screen">
      {/* Hero Section */}
      <section className="relative isolate min-h-[300px] overflow-hidden bg-gradient-to-r from-blue-500 to-indigo-600">
        ...
        <div className="relative px-6 pt-16 pb-8 sm:pt-20 sm:pb-12">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-white/90 max-w-3xl mx-auto drop-shadow-md">
              Comprehensive sensory assessment tool to identify triggers and develop personalised coping strategies
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-6">
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-blue-100">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-blue-800 mb-2">About This Sensory Profile</h3>
                <p className="text-blue-700 text-sm leading-relaxed">
                  ...
                  for yourself, prevent sensory overload, and create better environments for work, socialising, and daily life. 
                  You can share your completed profile with employers, healthcare providers, support services, and family 
                  to help them understand your needs.
                </p>
              </div>
            </div>
          </div>
