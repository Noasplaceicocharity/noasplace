...
export default async function LeadRolesPage() {
  ...
  return (
    <SectionLanding
      ...
      intro={`Lead roles at Noa's Place are for people who want to lead the way as volunteers. You'll be a key part of a values-led team focused on practical, compassionate support. These aren't just "extra hands" roles; they're opportunities to shape our culture, drive our partnerships, and ensure SEND families in Halifax get the right help, right when they need it.`}
      vacancies={vacancies}
